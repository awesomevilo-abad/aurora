                                                ...
                                                <div class="row mg-files" data-sort-destination data-sort-id="media-gallery">
                                                    <div class="isotope-item document">
                                                        <div style="margin:20px;">
															 ...
															 <form method="post" action="Report/export.php" align="center">  
																	<div class="col-md-3" style="text-align:left">
																		<label for=""><strong>Date Audited</strong></label>
																		

																	<select style="width:300px;" onchange="enableBuilding(this.value)" id="Date" name="Date" class="form-control">
																		<option></option>
																	</select>
																	...
																	<div class="col-md-3" style="text-align:left">
																		...
																		<div class="col-md-3" style="">
																			<button type="button" onclick="filteredloadData('<?php echo $position ?>')" class="btn btn-default" style="margin-top:25px;" ><img src="icons/view.png" style="height:25px; width:25px">View Records</button>
