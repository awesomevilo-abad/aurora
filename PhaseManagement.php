...
<html class="fixed sidebar-left-collapsed">
	...
	<body>
		...
		<?php include 'header.php'?>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
								...
								<form id="formData"  class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
									<section class="panel">
										<header class="panel-heading">
											...
											<h2 class="panel-title">Phase Management</h2>
											<p class="panel-subtitle">
												Enroll Phase Details Here
											</p>
										</header>
										...
										<div class="panel-body">
											<div class="form-group">
												...
												<?php
												$sql = "SELECT MAX(Pid) + 1 FROM phase;";
												$getPid = $conn->prepare($sql);
												$getPid->execute(); // no need to add `$sql` here, you can take that out
												$PidCounter = $getPid->fetchColumn();
												
												?>
												<input type="hidden" name="id" id="id" class="form-control"  required/>
												<input type="hidden" name="idcounter" id="idcounter" value="<?php echo $PidCounter ?>" class="form-control"  required readonly/>
													<input type="text" name="Name" id="Name" class="form-control"  required/>
												</div>
											</div>

										<div class="form-group">
											<label class="col-sm-1 control-label"> Building <span class="required">*</span></label>
												<div class="col-sm-12">
											...
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="hidden" name="percentage" id="percentage" class="form-control" required/>
												</div>
											</div>
								...
								<div id="importbuilding">
									<!-- Import Building -->
										<section class="panel">
											...
											<div class="panel-body" >
												<form method="post" action="Phase/import.php" enctype="multipart/form-data">
													<fieldset>
														<div class="form-group">
					...
					<!-- MODAL INCLUDE -->
					<?php include("phase/modal_assign.php");?>
					<?php include("phase/modal_change.php");?>
		...
		<!-- Examples -->
		<script src="Phase/Phase.js"></script>
