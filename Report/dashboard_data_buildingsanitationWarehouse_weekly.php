<?php
	...
	$conn = $dao->openConnection();
				...
				$building = [];
				$grades = $conn->prepare("SELECT timedatephase.week,AVG(timedatephase.protect_sani_grade) as BuildingGrade, timedatephase.pid,building.id, building.Name
                FROM timedatephase left join phase on timedatephase.pid = phase.Pid 
                left join building on phase.Bid = building.id 
                Where phase.PName LIKE '%Warehouse%' and timedatephase.month = '".$month."' and building.Name = '".$buildingname_var."'
