                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf"> 
                        <thead>
                            <?php   
                                     ...
                                     $date= $_POST['date'];
                                    $table = $crudcontroller->changedate_building_viewscores($date);
                                    if (! empty($table)) {
                        ...
                        <tbody>
                            ...
                            <?php
                                    ...
                                    WHERE checklist_grade.Bid ='".$building."' and timedatephase.protect_sani_grade != ''  and timedatephase.date_checked = '".$date."'
