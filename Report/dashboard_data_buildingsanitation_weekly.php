<?php
	...
	$conn = $dao->openConnection();
				...
				$building = [];
				$grades = $conn->prepare("SELECT week,pid,id,Name,PName, AVG(protect_sani_grade) as newWeekGrade 
                ...
                Where phase.PName NOT LIKE'%Warehouse%' and timedatephase.month = '".$month."' and timedatephase.year = '".$year."' and building.Name = '".$buildingname_var."' 
                GROUP BY timedatephase.pid,timedatephase.week ORDER by timedatephase.protect_sani_grade DESC) as newWeek 
