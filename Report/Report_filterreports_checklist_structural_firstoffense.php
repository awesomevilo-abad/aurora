	...
	<section class="panel col-sm-12">
        <div class="panel-body">
            ...
            <a class="pull-right"  href="printAuditStructural1stOffense.php?phase=<?php echo $_POST['phase'] ?>&start_auditreport=<?php echo $_POST['start_auditreport']?>&end_auditreport=<?php echo $_POST['end_auditreport']?>&auditee=<?php echo $_SESSION['AcName']?>" style="border-top-left-radius:20px;border-top-right-radius:20px;height:30px;width:30px;background-color:#ff57229c;" ><img src="icons/pdf.png" style="height:20px; width:20px;margin:5px;" data-toggle="tooltip" title="Print / Save to PDF"></a>
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf"> 
                        ...
                        ?>
                            <tr>
                                ...
                                <th colspan="8"  style="text-align:center;background-color:#00476b;border-bottom:#00476b;color:#fdfdfd;border-top-right-radius:;">Viewing of 1st Offense - Structural </th> <!--<?php echo $table[$k]['protect_stru_grade'] ?> % -->
                            </tr>
                        ...
                        <tr>
                             <?php
                            $table2 = $crudcontroller->filterReports_checklist_firstoffense_str();
                            if (! empty($table2)) {
                            ?><tr><?php
                            ...
                            <td style="background-color:#0088cc26">Structural</td>
                            ...
                            <?php
                                ...
                                ,timedatephase.targetGrade_status_str,timedatephase.declineReason,timedatephase.qastaff
                                ,checklist.Stru_One,checklist.Stru_Two FROM checklist_grade 
                                ...
                                WHERE checklist_grade.Aid ='".$table2[$k]['Aid']."' and checklist_grade.Date_Checked = '".$Date."' and checklist_grade.Str_Grade = 75
                            ...
                            <tr>
                                ...
                                if($rowshowAreas['remarks']==""){
                                    ?><td><?php echo $rowshowAreas['Stru_Two'];?></td><?php
                                }else{
                                    ?><td><?php echo $rowshowAreas['remarks'];?></td><?php
                                }
                                ?>
