<?php
	...
	$conn = $dao->openConnection();
                ...
                $week = $_POST['week'];
				$building = [];
				$grades = $conn->prepare("SELECT timedatephase.week,timedatephase.protect_stru_grade, timedatephase.pid,building.id, building.Name,phase.PName
                ...
                GROUP BY timedatephase.pid ORDER by timedatephase.protect_stru_grade DESC  ");
				$grades->execute();
