	...
	<section class="panel col-sm-12">
        <div class="panel-body">
            ...
            <a class="pull-right"  href="printAuditEquipment.php?phase=<?php echo $_POST['phase'] ?>&start_auditreport=<?php echo $_POST['start_auditreport']?>&end_auditreport=<?php echo $_POST['end_auditreport']?>&auditee=<?php echo $_SESSION['AcName']?>" style="border-top-left-radius:20px;border-top-right-radius:20px;height:30px;width:30px;background-color:#ff57229c;" ><img src="icons/pdf.png" style="height:20px; width:20px;margin:5px;" data-toggle="tooltip" title="Print / Save to PDF"></a>
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf"> 
                        ...
                        <?php   
                               ...
                               $end_auditreport= date('Y-m-d',strtotime($_POST['end_auditreport']));
                                 $area= $_POST['area'];
                                $table = $crudcontroller->filterReports_checklist_equipment();
                                if (! empty($table)) {
                        ...
                        ?>
                            <tr>
                                ...
                                <th colspan="8"  style="text-align:center;background-color:#b4700d;border-bottom:#00476b;color:#fdfdfd;border-top-right-radius:;">Equipment</th>
                            </tr>
                        ...
                        <tr>
                             <?php
                            $table2 = $crudcontroller->filterReports_checklist_equipment();
                            if (! empty($table2)) {
                            ?><tr><?php
                            ...
                            <?php
                                ...
                                WHERE area.Pid = '".$phase."' and equipment_grade.aid = '".$area."'   and equipment_grade.Name != 'No Equipment' and equipment_grade.Date_Checked_equipment >='".$start_auditreport."' and equipment_grade.Date_Checked_equipment <='".$end_auditreport."' 
