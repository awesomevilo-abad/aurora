<?php
	...
	$conn = $dao->openConnection();
				...
				$building = [];
				$grades = $conn->prepare("SELECT week,protect_equip_grade,pid,id,Name,PName, AVG(protect_equip_grade) as newBuildingGrade 
                ...
                Where phase.PName NOT LIKE'%Warehouse%' and timedatephase.month = '".$month."' and timedatephase.week = '".$week."' and timedatephase.year = '".$year."' 
