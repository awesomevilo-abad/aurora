                            ...
                            <tr class="">
                                ...
                                //   $rowshowImage = $showImage->fetch(PDO::FETCH_ASSOC);
                                    ...
                                    if($showImage->rowCount() > 0){
                                        ?>
                                        <td class="center"><a href="#"  onclick="ViewHistory('<?php echo $table[$k]['Aid']; ?>','<?php echo $table[$k]['AName']; ?>','<?php echo $table[$k]['Date_Checked']; ?>','<?php echo $table[$k]['PName']; ?>')" ><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        With Image
                                        </td>
                                        <?php
                                    }else{
