<?php
	...
	$conn = $dao->openConnection();
                ...
                FROM (SELECT AVG(timedatephase.protect_equip_grade) as BuildingGrade, timedatephase.pid,phase.PName,building.id, building.Name 
                FROM timedatephase 
                left join phase on timedatephase.pid = phase.Pid
                left join building on phase.Bid = building.id 
                Where timedatephase.month = '".$month."' and timedatephase.year = '".$year."' and phase.PName Not Like '%Warehouse%' 
