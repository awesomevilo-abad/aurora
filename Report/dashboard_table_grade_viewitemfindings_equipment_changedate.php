            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf"> 
                        ...
                        <?php   
                                ...
                                $area= $_POST['area'];
                                 $date= $_POST['date'];
                                $table = $crudcontroller->changedate_viewitemfindings_equipment($_POST["date"]);
                                if (! empty($table)) {
                        ...
                        <tbody>
                                 <?php
                                    ...
                                    WHERE equipment_grade.aid = '".$area."' and equipment_grade.Name != 'No Equipment' and equipment_grade.Date_Checked_equipment ='".$date."'
