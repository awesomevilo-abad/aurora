            ...
            <div class="modal-wrapper">
                ...
                <div class="modal-text">
                   ...
                   <div  class="col-sm-5">
                    ...
                    <select  style="text-align:center;border:none" class="form-control pull-right" name="week" id="week" onchange="changeWeek_showYearIfDecember5thWeek(this.value)">
                    ...
                    <select  style="text-align:center;border:none" class="form-control pull-right" name="month" id="month" onchange="changeMonth_showYearIfDecember5thWeek(this.value)"required>
