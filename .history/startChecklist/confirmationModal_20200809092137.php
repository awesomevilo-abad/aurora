            ...
            <div class="modal-wrapper">
                ...
                <div class="modal-text">
                   ...
                   <div  class="col-4">
                    ...
                    <select  style="text-align:center;border:none" class="form-control  text-center" name="week" id="week" onchange="changeWeek_showYearIfDecember5thWeek(this.value)">
                    ...
                    <select  style="text-align:center;border:none" class="form-control  text-center" name="month" id="month" onchange="changeMonth_showYearIfDecember5thWeek(this.value)"required>
                    ...
                    <div  class="col-4" id="divyear">
                    <center><strong><label> Year: </label></strong></center>
                    <select  style="text-align:center;border:none" class="form-control  text-center" name="year" id="year" required>
                    <?php
                    for($i=0;$i<6;$i++){
