...
//  PINALITAN ANG $Datetodayminusfive  FROM -4 TO -5 PARA MAQUERY YUNG LATEST AUDIT NI QA WITHIN 1 days AS A RESULT NA DAGDAGAN NG 1 DAY DISABILITY YUNG NA AUDITED PHASED
 $Datetodayminusfive = date('Y-m-d', strtotime($Datetoday. ' - 1 days'));
                                ...
                                // kung may laman ang checklist_grade 
                                    if(isset($rowgetPhaseRecord['Pid'])){
                                        ...
                                        $rowgetPhase2 = $getPhase2->fetch(PDO::FETCH_ASSOC);
                                            ...
                                            // Additional Code 08052020 For 1 days Cutoff
                                            ...
                                            if(isset($Pid)){
                                                ...
                                                <a href="#" onclick="loadCat()" ><h5 style="text-decoration:none;text-align:center;color:#fff;background-color:#dfdfdf" class="mg-title text-bold">Back</h5></a>
                                                    <div class="thumbnail" style="background-color:#34495e;border-radius:10%;height:400;">
                                                            ...
                                                            if(($rowgetAuditAreaPerPhase['countAid'] == 0) || ($AuditCutoffFormat < $Datetoday)){
                                                                ...
                                                                $AuditCutoffDone = date('M d Y (D)', strtotime($rowgetDateCheckedWhenDone['Date_Checked']. ' + 1 days'));  
                                                            ...
                                                            <p style="text-align:center;color:#fff;font-size:10px;" class="mg-title text-small"><?php echo 'Available Since: '.$AuditCutoffDone; ?></p>
                                                                ...
                                                                $AuditCutoffDone = date('M d Y (D)', strtotime($rowdatechecked['Date_Checked']. ' +1 days'));
                                    ...
                                    $getPhaseRecord3 = $conn->prepare("SELECT Distinct Pid FROM checklist_grade WHERE Bid=:Bid GROUP BY Pid ORDER BY Pid ASC ");
                                       ...
                                       $rowgetPhase3 = $getPhase3->fetch(PDO::FETCH_ASSOC);
                                            ...
                                            $datechecked = date('M d Y (D)',strtotime($rowdatechecked['Date_Checked']));
                                            // Additional Code 08052020 For 1 days Cutoff
                                            $AuditCutoff = date('M d Y (D)', strtotime($rowdatechecked['Date_Checked']. ' + 1 days'));
                                            // End Additional
                                            ...
                                            if(isset($Pid)){
                                                ...
                                                <div class="isotope-item document col-sm-6 col-md-4 col-lg-3">
                                                <a href="#" onclick="loadCat()" ><h5 style="text-decoration:none;text-align:center;color:#fff;background-color:#dfdfdf" class="mg-title text-bold">Back</h5></a>
                                                    <div class="thumbnail" style="background-color:#ce392b;border-radius:10%;height:400;">
                                                            <a class="thumb-image" onclick="completed('<?php echo $Pid?>')"  id="<?php echo $Pid?>">
                                                            <img  style="height:250px;border-radius:10%;" src="uploads/<?php echo $PImage?>" > </a>
                                                            <h5 style="text-align:center;color:#fff" class="mg-title text-semibold"><?php echo $PName ?>
                                                            <div style="margin:20;">
                                                            <small>
                                                            <p  style="color:#fff;background-color:#c9181073;padding:7px;border-radius:10px;margin-top:10px;">
                                                             Completed
                                                            </p>
                                                            </small> 
                                                            </div>
                                                            </h5>
                                                            <p style="text-align:center;color:#ffcbc3;font-size:10px;" class="mg-title text-semibold"><?php echo 'Last Audit: '.$datechecked; ?></p>
                                                            <p style="text-align:center;color:#ffcbc3;font-size:10px;" class="mg-title text-semibold"><?php echo 'Available On: '.$AuditCutoff; ?></p>
