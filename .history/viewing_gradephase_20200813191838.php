															...
															<div id="equip" class="tab-pane">
																	...
																	<div class="panel-body">
																		<table class="table table-bordered table-striped table-condensed mb-none">
																			...
																			<tbody>
																			<?php
																				$gradesequip = $conn->prepare("SELECT * FROM equipment_grade inner join area on equipment_grade.aid = area.Aid WHERE area.Pid=:Pid  and (equipment_grade.Date_Checked_equipment >= '$Datetodayminusfive' AND equipment_grade.Date_Checked_equipment <= '$Datetoday')  GROUP BY equipment_grade.Aid ORDER BY equipment_grade.Aid ASC ");
																				$gradesequip->execute(array(":Pid"=> $pid,"));
