															...
															<div id="sani" class="tab-pane active">
																...
																<div class="panel-body">
																	<table class="table table-bordered table-striped table-condensed mb-none">
																		...
																		<tbody>
																			<?php
																				$gradessanitation = $conn->prepare("SELECT * FROM checklist_grade inner join area on checklist_grade.Aid = area.Aid WHERE checklist_grade.Pid=:Pid and checklist_grade.Date_Checked =:datechecked GROUP BY checklist_grade.Aid ORDER BY checklist_grade.Aid ASC ");
																				$gradessanitation->execute(array(":Pid"=> $pid,":datechecked"=> $Datetoday));
															...
															<div id="stru" class="tab-pane">
																...
																<div class="panel-body">
																	<table class="table table-bordered table-striped table-condensed mb-none">
																		...
																		<tbody>
																		<?php
																				$gradesstructural = $conn->prepare("SELECT * FROM checklist_grade inner join area on checklist_grade.Aid = area.Aid WHERE checklist_grade.Pid=:Pid and checklist_grade.Date_Checked =:datechecked  GROUP BY checklist_grade.Aid ORDER BY checklist_grade.Aid ASC ");
																				$gradesstructural->execute(array(":Pid"=> $pid,":datechecked"=> $Datetoday));
