                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf"> 
                        ...
                        <?php   
                            ...
                            <tr>
                                ...
                                <th colspan="8"  style="text-align:center;background-color:#47a447;border-bottom:;;border-top-right-radius:;">Structural</th>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td style="background-color:#47a44733">Structural</td>
                            ...
                            <?php
                                ...
                                left join equipment_grade on area.Aid = equipment_grade.Aid and checklist_grade.Date_Checked = equipment_grade.Date_Checked_equipment
                                left join building on checklist_grade.Bid = building.id 
                                WHERE checklist_grade.Aid ='".$rowshowgrade['Aid']."' and checklist_grade.Date_Checked = '".$Date."' and checklist_grade.Str_Grade = 75
