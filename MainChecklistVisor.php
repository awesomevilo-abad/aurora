		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header" style="background-color:#ef8b14">
						<h2>Spot Audit</h2>
						...
						<div id="container" class="col-md-12">
									...
									<section class="panel" style="background-color:#ffffff">
										<header class="panel-heading" style="background-color:#EF8B14;">
											<h2 class="panel-title"style="color:#ffffff">	QA Supervisor</h2>
												<p class="panel-subtitle"style="color:#ffffff">
												
												</p>
										</header>
										<div style="margin:10px;" id="checklistvisor">
										...
										?>
										">
										<input type="hidden" id="checklistidvisor" value="<?php echo $_GET['id']?>">
										<input type="hidden" value="<?php echo $_SESSION['AcName']?>" name="AcName" id="AcName"/>
										</div>
									</section>

									<?php include 'startChecklist/modal_skipconfirmation.php'?> <!--Modal-->
									<?php include 'startChecklist/modal_addmoreImg_visor.php'?>
									<?php include 'startChecklist/modal_addmoreImg_visor_noncompliance.php'?>
							</div>
					<!-- end body -->	
				</section>
			</div>
