                                                ...
                                                ?>
                                                     <tr style="text-align:;">
                                                       ...
                                                       <?php
                                                        ...
                                                        ?></td>                                                       
                                                        <td>
                                                            <button id="<?php echo $table[$k]["Cid"]; ?>" class="bn-edit mb-xs mt-xs mr-xs btn btn-default"><img src="icons/edit.png" style="height:25px; width:25px"></button>
                                                            <button id="<?php echo $table[$k]["Cid"]; ?>" class="bn-delete mb-xs mt-xs mr-xs btn btn-default"><img src="icons/delete.png" style="height:25px; width:25px"></button>
                                                        </td>
                                                    </tr>                  
                                            <?php }}?>     
                                            </tbody>
