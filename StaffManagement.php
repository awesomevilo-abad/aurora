		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div id="showdata" class="col-md-5">
									...
									<section class="panel">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-12">
												<div class="form-group">
													<label class="col-sm-1 control-label"> Full Name <span class="required">*</span></label>
													<div class="col-sm-12">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label"> Position <span class="required">*</span></label>
                                                        <select name="pos" id="pos" class="form-control" required>
                                                                ...
                                                                <option value="Protect">Protech</option>
                                                                <option value="Manager">Manager</option>
                                                                <option value="QA Manager">QA Manager</option>
                                                                <option value="Supervisor">Supervisor</option>
                                                                <option value="ADMIN">Administrator</option>
																<option value="Fixed Asset Specialist">Fixed Asset Specialist</option>
                                                        </select>
												</div>


												<div class="form-group">
													<label class="col-sm-1 control-label"> Department <span class="required">*</span></label>
													<div class="col-sm-12">
														<input type="text" name="department" id="department" class="form-control"  required/>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-1 control-label"> Username <span class="required">*</span></label>
													<div class="col-sm-12">
														<input type="text" name="user" id="user" class="form-control"  required/>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-1 control-label"> Password <span class="required">*</span></label>
													<div class="col-sm-12">
					...
					<section class="panel col-md-7">
						...
						<!-- MODAL INCLUDE -->
						<?php include("Staff/modal_assign.php")?>
						<?php include("Staff/modal_addPhase.php")?>
