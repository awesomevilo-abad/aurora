	...
	<section class="panel col-sm-12">
							...
							<div class="panel-body">
                                ...
                                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                                    ...
                                    <tbody>
                                            <?php
                                                $table = $crudcontroller->viewEquipmentOffense($_POST['year'],$_POST['month'],$_POST['week'],$_POST['offense']);
                                                        if (! empty($table)) {
                                                    foreach ($table as $k => $v) {
                                                ?>
                                                     <tr style="text-align:;">
                                                        <td><?php echo trim($table[$k]["id"]); ?></td>
                                                        <td><?php echo trim($table[$k]["Asset_Tag"]); ?></td>
                                                        <td><?php echo trim($table[$k]["Asset_Number"]); ?></td>
                                                        <td><?php echo trim($table[$k]["EName"]); ?></td>
                                                        <td>
                                                        ...
                                                        <td><?php echo trim($table[$k]["egrade"]); ?></td>
                                                        <td><?php echo trim($table[$k]["remarksequip"]); ?></td>
                                                        <td><?php echo trim($table[$k]["week"]); ?></td>
                                                        <td><?php echo trim($table[$k]["Date_Checked_equipment"]); ?></td>
