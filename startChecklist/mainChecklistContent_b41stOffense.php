                                        ...
                                        <header class="panel-heading">
                                            ...
                                            // echo $Datetoday;
                                                ...
                                                <table>
                                                   ...
                                                   <span style="background-color:#d2322d;margin-left:10px; padding:5px; border-top-left-radius:10px; border-bottom-left-radius:10px;color:#fff;font-size:10px;"><strong><?php echo $month ?></strong></span>
                                                   <input type="hidden" name="month" id="month" value="<?php echo $month?>"/>
                                                   <span style="background-color:#8d0703; padding:5px; border-top-right-radius:10px;; border-bottom-right-radius:10px;color:#fff;font-size:10px;"><strong><?php echo $year ?></strong></span>
