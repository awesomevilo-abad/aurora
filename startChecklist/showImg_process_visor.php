<?php
    ...
    $Datetoday=$_POST['date'];
                ...
                $stmtshowImage = $conn->prepare("SELECT * FROM image_visor where Aid = :aid and Date_Checked = :datechecked and type = 'compliance'");
                ...
                <img src='uploaded/" . $imagename. "' style='margin-top:20px;height:50px;width:50px;'><br> 
