...
<html class="fixed sidebar-left-collapsed">
	...
	<body>
						...
						<div id="showdata" class="col-md-12">
									...
									<section class="panel" style="background-color:#ffffff">
										<header class="panel-heading">
											<h2 class="panel-title">View Equipment Offense</h2>
                                                ...
                                                <div class="row mg-files" data-sort-destination data-sort-id="media-gallery">
                                                    <div class="isotope-item document">
                                                        <div style="margin:30px;">
                                                                  ...
                                                                  <form method="post" action="Offense/exportEq.php">  
                                                                    ...
                                                                    <div class="col-md-3">Offense
                                                                        <select  name="offense" onChange='changeOffense(this.value)'id="offense" class="form-control">
                                                                            ...
                                                                            <option value="Non-Functional">Damaged</option>
                                                                            <option value="Not Onsight">Not On Site</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-md-3" >
                                                                    ...
                                                                    <div  class="col-md-12"  id="viewOffense" style="text-align:center;">
																		Please Wait...
                                                                    </div>
		...
		<script src="Offense/offense.js"></script>
