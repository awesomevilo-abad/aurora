...
<html class="fixed sidebar-left-collapsed">
	...
	<body>
						...
						<div id="showdata" class="col-md-12">
									...
									<section class="panel" style="background-color:#ffffff">
										<header class="panel-heading">
											<h2 class="panel-title">View Structural Offense</h2>
                                                ...
                                                <div class="row mg-files" data-sort-destination data-sort-id="media-gallery">
                                                    <div class="isotope-item document">
                                                        <div style="margin:30px;">
                                                                  ...
                                                                  <form method="post" action="Offense/exportSt.php">  
                                                                    ...
                                                                    <div  class="col-md-12"  id="viewOffenseStructural" style="text-align:center;">
																		Please Wait...
                                                                    </div>
		...
		<script src="Offense/offenseStructural.js"></script>
