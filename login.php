						...
						<form action="" method="post">
							...
							<div class="row">
								<div class="col-sm-8">
									...
									<input type="radio" name="position" value="QA Staff" required/>QA Staff
									<input type="radio" name="position" value="QA Supervisor" required/>QA Supervisor
    									 <input type="radio" name="position" value="Admin" required/>Admin
