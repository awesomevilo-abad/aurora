                                   ...
                                   <div id="shownav"><img src="icons/view.png" style="display:;height:20px;cursor:pointer" class="pull-left" data-toggle="tooltip" title="Show Navigation" onclick='shownavigation()'></div>
                                        <br><div id="auditreport-nav">
                                                ...
                                                <div id="auditreport">
                                                        ...
                                                        Choose Date: 
                                                        <div id="dateset"style="display:">
                                                            <select data-plugin-selectTwo name="datedash" id="datedash" class="form-control populate" style="display:"  required>
                                                    ...
                                                    <button id="filterreport" onclick="filterReports()" class="pull-right" style="border-radius:50px;margin:10px;"><img src="icons/filter.png" style="height:15px;">Filter</button>
                                                    <button id="filterreport_phase"  onclick="filterReports_phase()" class="pull-right" style="border-radius:50px;margin:10px;"><img src="icons/filter.png" style="height:15px;">Filter</button>
                                                </div>
                                                <div id="checklist" style="display:none">
                                                    Type of Audit: 
                                                    <select d-ata-plugin-selectTwo name="" id="Report_type" class="form-control populate" onChange='changereporttype(this.value)' required>
                                                    ...
                                                    <?php
                                                        ...
                                                        Choose Phase <select data-plugin-selectTwo name="Report_phase_checklist" id="Report_phase_checklist" class="form-control populate" onChange='changedata_checklist(this.value)' required>
                                                            <?php foreach ($results as $row) { ?>
                                                        ...
                                                        <?php } ?> 
                                                         ...
                                                         <select data-plugin-selectTwo name="Report_area_checklist" id="Report_area_checklist" style="display:none" class="form-control populate"  required>
                                                        ...
                                                        Choose Date: 
                                                        <div id="dateset"style="display:">
                                                            <select data-plugin-selectTwo name="Report_date_checklist" id="Report_date_checklist" class="form-control populate" style="display:"  required>
                                                                        <option>Select Date </option>
                                                                <?php foreach ($results as $row) { ?>
                                                                        <option value="<?php echo $row['Date_Checked']?>"><?php echo $row['Date_Checked']?></option>
                                                                <?php } ?>
                                                    ...
                                                    <button id="filterreport_checklist" onclick="filterReports_checklist()" class="pull-right" style="border-radius:50px;margin:10px;"><img src="icons/filter.png" style="height:15px;">Filter</button>
                                                    <button id="filterreport_area_checklist"  onclick="filterReports_area_checklist()" class="pull-right" style="border-radius:50px;margin:10px;"><img src="icons/filter.png" style="height:15px;">Filter</button>

                                                </div>
                                        </div>
                                        <div style="display:none" id="dashboardtable_max" class="col-sm-12"> </div>
                                        <div style="display:none" id="dashboardtable_min" class="col-sm-9"> </div>
                                    </div>
                            </div>
